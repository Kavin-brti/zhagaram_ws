...
const Nav = () => {
    const menu=(
                    <Menu>
                            <Menu.Item>
                                <a target="_blank" rel="noopener noreferrer" href="/pongal">
                                பொங்கல் 
                                </a>
                            </Menu.Item>
                            <Menu.Item>
                                <a target="_blank" rel="noopener noreferrer" href="/dhuruvam">
                                துருவம் 
                                </a>
                            </Menu.Item>
                            <Menu.Item>
                                <a target="_blank" rel="noopener noreferrer" href="/yaazh">
                                யாழ் 
                                </a>
                            </Menu.Item>
                            <Menu.Item>
                                <a target="_blank" rel="noopener noreferrer" href="/vishai">
                                விதை
                                </a>
                            </Menu.Item>
                     </Menu>
